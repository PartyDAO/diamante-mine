...
contract DeployUpgradeableDiamanteMineDev is Script {
    ...
    function run() external returns (address[] memory proxies) {
        ...
        DiamanteMineV1_2Dev implementation = new DiamanteMineV1_2Dev(PERMIT2);
        ...
        appIds[1] = "app_44080323ee897f20dfbacdd30cedf2a8"; // Marcus
        appIds[2] = "app_2f15cba47775504177f6fa2729103ad6"; // Steve
        appIds[3] = "app_af6f1a981af93b88be6e35c7d787964f"; // Jeremy
        ...
        for (uint256 i = 0; i < appIds.length; i++) {
            ...
            bytes memory data = abi.encodeWithSelector(
                DiamanteMineV1_2Dev.initialize.selector,
                msg.sender,
                MOCK_DIAMANTE,
                MOCK_ORO,
                minAmountOro,
